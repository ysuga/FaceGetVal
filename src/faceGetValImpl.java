    ...
    protected ReturnCode_t onExecute(int ec_id) {
       int likes = 0, comment = 0;
    	...
    	if(m_urlIn.isNew()){
	    	...
	    	m_urlIn.read();
			subData = m_urlIn.extract();
			url = subData.data;
			try{
				URL fql = new URL("https://api.facebook.com/method/fql.query?query=select%20%20like_count,%20share_count,%20comment_count,%20total_count%20from%20link_stat%20where%20url=%22"+ url +"%22");
	    		...
	    		System.out.println("like_count = " + nl2.item(0).getFirstChild().getNodeValue());
	    		
	    		NodeList nl3 = ((Element)nd1).getElementsByTagName("comment_count");
	    		
	    		subVal01.data = Integer.parseInt(nl2.item(0).getFirstChild().getNodeValue());
	    		subVal02.data = Integer.parseInt(nl3.item(0).getFirstChild().getNodeValue());
